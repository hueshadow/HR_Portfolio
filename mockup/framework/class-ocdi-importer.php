	...
	public function import_files_config() {
		...
		$home_prevs = array(
			'medinet_home_1' => array(
				'title' => __( 'Import Akordian', 'akordian' ),
				'page'  => __( 'Home Akordian', 'akordian' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/akordian/',
			),
			'medinet_home_2' => array(
				'title' => __( 'Import Home One Page', 'akordian' ),
				'page'  => __( 'Home One Page', 'akordian' ),
				'screenshot' => get_template_directory_uri() . '/sample-data/screenshot.png',
				'preview_link' => 'https://shtheme.com/demosd/akordian/?page_id=37',
			),
		);
		...
		foreach ( $home_prevs as $key => $prev ) {
			...
			$config[] = array(
				...
				'import_notice'              => esc_html__( 'After you import this demo, you will have to setup the slider separately.', 'akordian' ),
			);
		}
