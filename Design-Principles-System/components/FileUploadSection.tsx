...
const FileUploadSection: React.FC<FileUploadSectionProps> = ({ isEmbedded = false }) => {
  const containerClass = isEmbedded 
    ? "contents" // Use contents to let children participate in parent layout
  ...
  const content = (
    <>
        ...
        <div className={cardClass}>
            ...
            <div className="border-2 border-dashed border-slate-200 dark:border-slate-600 rounded-xl p-8 flex flex-col items-center justify-center text-center hover:border-primary transition-colors cursor-pointer group">
                <span className="material-icons-outlined text-slate-400 group-hover:text-primary mb-3 text-4xl">cloud_upload</span>
                <p className="text-sm font-medium text-slate-900 dark:text-white">Drag and drop your files, or <span className="text-primary font-bold">browse</span></p>
        ...
        <div className={cardClass}>
            ...
            <div className="space-y-3">
                <div className="flex items-center p-3 bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-100 dark:border-slate-700">
                    ...
                    <button className="text-slate-400 hover:text-primary"><span className="material-icons-outlined text-lg">download</span></button>
                </div>
                <div className="p-3 bg-slate-50 dark:bg-slate-900/50 rounded-lg border border-slate-100 dark:border-slate-700">
                    ...
                    <div className="w-full bg-slate-200 dark:bg-slate-700 h-1.5 rounded-full overflow-hidden">
                        <div className="bg-primary h-full rounded-full transition-all duration-300" style={{ width: '65%' }}></div>
                    </div>
                </div>
            </div>
            <button className="w-full mt-4 py-2 bg-primary text-white rounded-lg font-medium hover:bg-blue-700 transition-colors">Upload Files</button>
        </div>

        {/* Local vs Dropbox */}
        <div className={cardClass}>
            <div className="flex border-b border-slate-100 dark:border-slate-700 mb-6">
                <button className="px-4 py-2 text-sm font-semibold border-b-2 border-primary text-primary">Local</button>
            ...
            <div className="border-2 border-dashed border-slate-200 dark:border-slate-600 rounded-xl p-6 text-center">
                ...
                <p className="text-sm font-medium mb-1 text-slate-900 dark:text-white">Drag your files here, or <span className="text-primary font-bold">choose file</span></p>
            ...
            <div className="mt-6 flex gap-3">
                ...
                <button className="flex-1 py-2 bg-primary text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors">Upload</button>
            </div>
        </div>
        ...
        <div className={cardClass}>
            ...
            <div className="border-2 border-dashed border-slate-200 dark:border-slate-600 rounded-xl py-6 flex flex-col items-center justify-center bg-slate-50/50 dark:bg-slate-900/20">
                ...
                <p className="text-sm font-medium text-slate-900 dark:text-white">Drag your image or <span className="text-primary font-bold">browse</span></p>
            </div>
            ...
            <div className="flex gap-2">
                <input className="flex-1 text-sm rounded-lg border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 focus:ring-primary focus:border-primary text-slate-900 dark:text-white" placeholder="Paste image link" type="text"/>
        ...
        <div className={`${cardClass} flex flex-col items-center justify-center min-h-[350px]`}>
            ...
            <div className="relative flex items-center justify-center mb-8">
                <svg className="w-48 h-48 transform -rotate-90" viewBox="0 0 128 128">
                    ...
                    <circle className="text-primary" cx="64" cy="64" fill="transparent" r="56" stroke="currentColor" strokeDasharray="351.85" strokeDashoffset="63.3" strokeWidth="8" strokeLinecap="round"></circle>
                </svg>
        ...
        <div className={cardClass}>
            ...
            <div className="border-2 border-dashed border-red-200 dark:border-red-900/30 rounded-xl p-8 flex flex-col items-center justify-center text-center bg-red-50/10">
                ...
                <button className="mt-4 text-xs font-bold text-primary hover:underline">BROWSE FILES</button>
            </div>
            <div className="mt-6 flex justify-between items-center">
                ...
                <button className="px-6 py-2 bg-primary text-white rounded-lg text-sm font-medium shadow-lg shadow-blue-500/20 opacity-50 cursor-not-allowed">Upload</button>
            </div>
        </div>

        {/* Attach Documents (Full Width Logic handled by masonry flow usually, or we can leave it as a card) */}
        <div className={cardClass}>
