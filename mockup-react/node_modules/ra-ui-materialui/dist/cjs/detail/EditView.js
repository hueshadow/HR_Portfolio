...
var EditView = function (props) {
    var _a;
    var actions = props.actions, aside = props.aside, children = props.children, render = props.render, className = props.className, _b = props.component, Content = _b === void 0 ? material_1.Card : _b, _c = props.emptyWhileLoading, emptyWhileLoading = _c === void 0 ? false : _c, _d = props.offline, offline = _d === void 0 ? defaultOffline : _d, title = props.title, rest = __rest(props, ["actions", "aside", "children", "render", "className", "component", "emptyWhileLoading", "offline", "title"]);
    var hasShow = (0, ra_core_1.useResourceDefinition)().hasShow;
    var editContext = (0, ra_core_1.useEditContext)();
    var resource = editContext.resource, defaultTitle = editContext.defaultTitle, record = editContext.record, isPaused = editContext.isPaused, isPending = editContext.isPending;
    ...
    if (isPaused && isPending && offline !== undefined && offline !== false) {
        return (React.createElement(Root, __assign({ className: (0, clsx_1.default)('edit-page', className) }, rest),
            React.createElement("div", { className: (0, clsx_1.default)(exports.EditClasses.main, exports.EditClasses.noActions) },
                React.createElement(Content, { className: exports.EditClasses.card }, offline),
                aside)));
    }
    ...
    return (React.createElement(Root, __assign({ className: (0, clsx_1.default)('edit-page', className) }, rest),
        ...
        React.createElement("div", { className: (0, clsx_1.default)(exports.EditClasses.main, (_a = {},
                ...
                _a)) },
            React.createElement(Content, { className: exports.EditClasses.card }, render ? (render(editContext)) : record ? (children) : (React.createElement(material_1.CardContent, null, "\u00A0"))),
            aside)));
};
