...
var List = function (props) {
    var _a = (0, styles_1.useThemeProps)({
        props: props,
        name: PREFIX,
    }), debounce = _a.debounce, disableAuthentication = _a.disableAuthentication, disableSyncWithLocation = _a.disableSyncWithLocation, exporter = _a.exporter, _b = _a.filter, filter = _b === void 0 ? defaultFilter : _b, filterDefaultValues = _a.filterDefaultValues, _c = _a.loading, loading = _c === void 0 ? defaultLoading : _c, _d = _a.perPage, perPage = _d === void 0 ? 10 : _d, queryOptions = _a.queryOptions, resource = _a.resource, sort = _a.sort, storeKey = _a.storeKey, render = _a.render, rest = __rest(_a, ["debounce", "disableAuthentication", "disableSyncWithLocation", "exporter", "filter", "filterDefaultValues", "loading", "perPage", "queryOptions", "resource", "sort", "storeKey", "render"]);
