...
export var ShowView = function (props) {
    ...
    if (isPaused && isPending && offline !== undefined && offline !== false) {
        return (React.createElement(Root, __assign({ className: clsx('show-page', className) }, rest),
            React.createElement("div", { className: clsx(ShowClasses.main, ShowClasses.noActions) },
                React.createElement(Content, { className: ShowClasses.card }, offline),
                aside)));
    }
    ...
    return (React.createElement(Root, __assign({ className: clsx('show-page', className) }, rest),
        ...
        React.createElement("div", { className: clsx(ShowClasses.main, (_a = {},
                ...
                _a)) },
            React.createElement(Content, { className: ShowClasses.card }, render ? render(showContext) : children),
            aside)));
};
var PREFIX = 'RaShow';
