...
export var EditView = function (props) {
    var _a;
    var actions = props.actions, aside = props.aside, children = props.children, render = props.render, className = props.className, _b = props.component, Content = _b === void 0 ? Card : _b, _c = props.emptyWhileLoading, emptyWhileLoading = _c === void 0 ? false : _c, _d = props.offline, offline = _d === void 0 ? defaultOffline : _d, title = props.title, rest = __rest(props, ["actions", "aside", "children", "render", "className", "component", "emptyWhileLoading", "offline", "title"]);
    ...
    if (isPaused && isPending && offline !== undefined && offline !== false) {
        return (React.createElement(Root, __assign({ className: clsx('edit-page', className) }, rest),
            React.createElement("div", { className: clsx(EditClasses.main, EditClasses.noActions) },
                React.createElement(Content, { className: EditClasses.card }, offline),
                aside)));
    }
    ...
    return (React.createElement(Root, __assign({ className: clsx('edit-page', className) }, rest),
        ...
        React.createElement("div", { className: clsx(EditClasses.main, (_a = {},
                ...
                _a)) },
            React.createElement(Content, { className: EditClasses.card }, render ? (render(editContext)) : record ? (children) : (React.createElement(CardContent, null, "\u00A0"))),
            aside)));
};
var PREFIX = 'RaEdit';
