...
var y = (t, e, r) => qt(t, typeof e != "symbol" ? e + "" : e, r);
var B = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function oe(t) {
  return t && t.__esModule && Object.prototype.hasOwnProperty.call(t, "default") ? t.default : t;
}
var Vt = Array.isArray, O = Vt, zt = typeof B == "object" && B && B.Object === Object && B, ut = zt, Jt = ut, Qt = typeof self == "object" && self && self.Object === Object && self, Wt = Jt || Qt || Function("return this")(), A = Wt, Yt = A, Xt = Yt.Symbol, L = Xt, we = L, ft = Object.prototype, Zt = ft.hasOwnProperty, kt = ft.toString, M = we ? we.toStringTag : void 0;
function er(t) {
...
var ht = Dr, Fr = dt, Br = Mr, Ur = E, Gr = ht, Kr = /[\\^$.*+?()[\]{}|]/g, Hr = /^\[object .+?Constructor\]$/, qr = Function.prototype, Vr = Object.prototype, zr = qr.toString, Jr = Vr.hasOwnProperty, Qr = RegExp(
  "^" + zr.call(Jr).replace(Kr, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Wr(t) {
  if (!Ur(t) || Br(t))
    return !1;
...
var S = ta, ra = S, aa = ra(Object, "create"), z = aa, Se = z;
function na() {
...
var oa = ia, ca = z, la = "__lodash_hash_undefined__", ua = Object.prototype, fa = ua.hasOwnProperty;
function da(t) {
  var e = this.__data__;
  if (ca) {
    var r = e[t];
...
var ha = da, ga = z, pa = Object.prototype, ya = pa.hasOwnProperty;
function ba(t) {
  var e = this.__data__;
  return ga ? e[t] !== void 0 : ya.call(e, t);
}
var va = ba, $a = z, _a = "__lodash_hash_undefined__";
function ma(t, e) {
  var r = this.__data__;
...
var qa = Ha, Va = J;
function za(t, e) {
  var r = this.__data__, a = Va(r, t);
  return a < 0 ? (++this.size, r.push([t, e])) : r[a][1] = e, this;
}
var Ja = za, Qa = Ia, Wa = Fa, Ya = Ga, Xa = qa, Za = Ja;
function I(t) {
  var e = -1, r = t == null ? 0 : t.length;
  for (this.clear(); ++e < r; ) {
    var a = t[e];
...
var ye = H.exports, Hi = Gi, qi = pe, Me = ye, Le = Me && Me.isTypedArray, Vi = Le ? qi(Le) : Hi, _t = Vi, zi = Qs, Ji = ni, Qi = O, Wi = ge, Yi = ui, Xi = _t, Zi = Object.prototype, ki = Zi.hasOwnProperty;
function eo(t, e) {
  var r = Qi(t), a = !r && Ji(t), n = !r && !a && Wi(t), s = !r && !a && !n && Xi(t), i = r || a || n || s, o = i ? zi(t.length, String) : [], c = o.length;
  for (var l in t)
...
var Tt = Jo, Qo = zo, Wo = Tt, Yo = Object.prototype, Xo = Yo.propertyIsEnumerable, Re = Object.getOwnPropertySymbols, Zo = Re ? function(t) {
...
var Sc = Cc, Ec = S, jc = A, Ic = Ec(jc, "DataView"), Pc = Ic, xc = S, Nc = A, Mc = xc(Nc, "Promise"), Lc = Mc, Rc = S, Dc = A, Fc = Rc(Dc, "Set"), Bc = Fc, Uc = S, Gc = A, Kc = Uc(Gc, "WeakMap"), Hc = Kc, re = Pc, ae = ue, ne = Lc, se = Bc, ie = Hc, It = R, N = ht, De = "[object Map]", qc = "[object Object]", Fe = "[object Promise]", Be = "[object Set]", Ue = "[object WeakMap]", Ge = "[object DataView]", Vc = N(re), zc = N(ae), Jc = N(ne), Qc = N(se), Wc = N(ie), T = It;
...
var cl = ol, He = L, qe = He ? He.prototype : void 0, Ve = qe ? qe.valueOf : void 0;
function ll(t) {
  return Ve ? Object(Ve.call(t)) : {};
}
var ul = ll, fl = _e;
function dl(t, e) {
...
var Bl = Fl, Ul = E, ze = Object.create, Gl = /* @__PURE__ */ function() {
  function t() {
  }
  return function(e) {
    if (!Ul(e))
...
}(), Kl = Gl, Hl = Kl, ql = Ct, Vl = be;
function zl(t) {
  return typeof t.constructor == "function" && !Vl(t) ? Hl(ql(t)) : {};
}
var Jl = zl, Ql = Z, Wl = C, Yl = "[object Map]";
function Xl(t) {
  return Wl(t) && Ql(t) == Yl;
}
...
V.prototype.add = V.prototype.push = hf;
V.prototype.has = gf;
var pf = V;
function yf(t, e) {
...
var jf = Ef, Xe = L, Ze = Pt, If = le, Pf = Rt, xf = Sf, Nf = jf, Mf = 1, Lf = 2, Rf = "[object Boolean]", Df = "[object Date]", Ff = "[object Error]", Bf = "[object Map]", Uf = "[object Number]", Gf = "[object RegExp]", Kf = "[object Set]", Hf = "[object String]", qf = "[object Symbol]", Vf = "[object ArrayBuffer]", zf = "[object DataView]", ke = Xe ? Xe.prototype : void 0, ee = ke ? ke.valueOf : void 0;
...
class ct {
  constructor({
    ...
    y(this, "sequence", 0);
    y(this, "items", []);
    y(this, "database", null);
    y(this, "name", null);
    y(this, "identifierName", "id");
    y(this, "getNewId");
    if (!Array.isArray(e))
      throw new Error(
  ...
  getAll(e) {
    ...
    return e && (r = r.map((a) => Object.assign({}, a)), e.embed && this.database && (r = r.map(this._itemEmbedder(e.embed))), e.filter && (r = Bt(r, e.filter)), e.sort && (r = qd(r, e.sort)), e.range && (r = Vd(r, e.range))), r;
  }
  getIndex(e) {
...
const Gd = (t, e) => t.reduce((r, a) => r && e(a), !0), Kd = (t, e) => t.reduce((r, a) => r || e(a), !1), Hd = (t, e) => t.reduce(
  (r, a, n) => {
    if (r != null)
      return r;
    const s = t.slice(0, n + 1).join("."), i = t.slice(n + 1).join("."), o = p(e, s);
  ...
  if (t.indexOf("_q") !== -1) {
    ...
    return (n) => {
      var s;
      return ((s = p(n, r)) == null ? void 0 : s.toString().match(a)) !== null;
    };
  }
  if (t.indexOf("_lte") !== -1) {
  ...
  return Array.isArray(e) ? (r) => Array.isArray(p(r, t)) ? Gd(e, (a) => {
    const n = p(r, t);
    return Array.isArray(n) ? Kd(n, (s) => s == a) : !1;
  }) : e.filter((a) => a == p(r, t)).length > 0 : e == null ? (r) => p(r, t) == null : typeof e == "object" ? (r) => Ld(e)(p(r, t)) : (r) => {
    const a = p(r, t);
...
function qd(t, e) {
  ...
  if (typeof e == "string")
    return t.sort((r, a) => {
      const n = p(r, e), s = p(a, e);
      return n > s ? 1 : n < s ? -1 : 0;
    });
  if (Array.isArray(e)) {
    const r = e[0], a = e[1].toLowerCase() === "asc" ? 1 : -1;
    return t.sort((n, s) => {
      const i = p(n, r), o = p(s, r);
      return i > o ? a : i < o ? -1 * a : 0;
    });
  }
