  ...
  const content = (
    <>
      ...
      <div className={cardClass}>
        <div className="px-4 py-3 border-b border-[var(--border-light)] dark:border-[var(--border-dark)] flex items-center justify-between bg-gray-50/50 dark:bg-gray-800/50">
          <span className="text-xs font-bold uppercase tracking-widest text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Notifications</span>
          <span className="h-5 w-5 rounded-full bg-[var(--primary)] text-white text-[10px] flex items-center justify-center font-bold">3</span>
        </div>
        <div className="divide-y divide-[var(--border-light)] dark:divide-[var(--border-dark)]">
          <div className="p-3 flex items-start gap-3 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors cursor-pointer">
            <div className="h-8 w-8 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center text-[var(--primary)] flex-shrink-0">
              <span className="material-symbols-outlined text-sm">database</span>
            </div>
            <div>
              <p className="text-xs font-semibold text-slate-900 dark:text-white leading-tight">Sync Completed</p>
              <p className="text-[10px] text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] mt-0.5">2,481 records processed successfully.</p>
            </div>
          </div>
          <div className="p-3 flex items-start gap-3 hover:bg-gray-50 dark:hover:bg-gray-800/40 transition-colors cursor-pointer">
            ...
            <div>
              ...
              <p className="text-[10px] text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] mt-0.5">Workspace "Sales_v2" hasn't been accessed in 7 days.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className={`${cardClass} p-3 flex items-center gap-3`}>
        <div className="relative">
          <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-[var(--primary)] to-purple-500 flex items-center justify-center text-white font-bold text-sm">JD</div>
          <div className="absolute bottom-0 right-0 h-3 w-3 bg-[var(--success)] border-2 border-white dark:border-[var(--surface-dark)] rounded-full"></div>
        </div>
        <div className="flex flex-col min-w-0">
          <span className="text-xs font-bold text-slate-900 dark:text-white truncate">Julian Drame</span>
          <span className="text-[10px] text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">System Architect</span>
        </div>
      </div>

      {/* File Types Grid */}
      <div className="break-inside-avoid mb-6 w-full flex flex-wrap gap-2">
        <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg border border-[var(--border-light)] dark:border-[var(--border-dark)] bg-white dark:bg-[var(--surface-dark)]">
        ...
        <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg border border-[var(--border-light)] dark:border-[var(--border-dark)] bg-white dark:bg-[var(--surface-dark)]">
          <span className="material-symbols-outlined text-[var(--primary)] text-sm">image</span>
          <span className="text-[10px] font-bold text-slate-700 dark:text-slate-300">JPG</span>
        </div>
        <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg border border-[var(--border-light)] dark:border-[var(--border-dark)] bg-white dark:bg-[var(--surface-dark)]">
          <span className="material-symbols-outlined text-[var(--success)] text-sm">table_chart</span>
      ...
      <div className={`${cardClass} p-4 flex flex-col justify-between`}>
        <div className="flex items-center justify-between">
          <span className="text-[10px] font-bold text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] uppercase">Sparkline</span>
          <span className="text-[10px] font-bold text-[var(--primary)]">+8.4%</span>
        </div>
      ...
      {/* Weather Card */}
      <div className={`${cardClass} p-4 bg-gradient-to-br from-blue-500 to-[var(--primary)] text-white border-transparent`}>
      ...
      <div className={`${cardClass} p-2 h-fit`}>
        <div className="space-y-1">
          <div className="flex items-center gap-3 px-3 py-2 bg-[var(--primary)]/10 text-[var(--primary)] rounded-lg">
            <span className="material-symbols-outlined text-lg">dashboard</span>
            <span className="text-sm font-semibold">Overview</span>
          </div>
          <div className="flex items-center gap-3 px-3 py-2 text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] hover:bg-gray-100 dark:hover:bg-gray-800 rounded-lg transition-colors cursor-pointer">
      ...
      <div className={`${cardClass} p-5`}>
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-xs text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Next payment due Oct 24, 2023</p>
          </div>
          <button className="px-3 py-1.5 text-[10px] font-bold bg-[var(--primary)]/10 text-[var(--primary)] rounded-lg border border-[var(--primary)]/20 hover:bg-[var(--primary)]/20 transition-colors">MANAGE</button>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-[var(--border-light)] dark:border-[var(--border-dark)]">
            <p className="text-[10px] font-bold text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] mb-1 uppercase">Total Spent</p>
            <p className="text-xl font-bold text-slate-900 dark:text-white">$12,450.00</p>
          </div>
          <div className="p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-[var(--border-light)] dark:border-[var(--border-dark)]">
            <p className="text-[10px] font-bold text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] mb-1 uppercase">Usage Tier</p>
      ...
      <div className={`${cardClass} p-5`}>
        <div className="flex justify-between items-center mb-6">
          <span className="text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Weekly Volume</span>
          <span className="material-symbols-outlined text-gray-400 text-lg cursor-pointer">more_vert</span>
        </div>
        <div className="flex items-end justify-between h-24 gap-1">
          <div className="w-full bg-[var(--primary)]/20 rounded-t-sm h-[40%]"></div>
          <div className="w-full bg-[var(--primary)]/40 rounded-t-sm h-[60%]"></div>
          <div className="w-full bg-[var(--primary)] rounded-t-sm h-[90%]"></div>
          <div className="w-full bg-[var(--primary)]/60 rounded-t-sm h-[50%]"></div>
          <div className="w-full bg-[var(--primary)]/30 rounded-t-sm h-[75%]"></div>
          <div className="w-full bg-[var(--primary)]/50 rounded-t-sm h-[30%]"></div>
          <div className="w-full bg-[var(--primary)]/80 rounded-t-sm h-[85%]"></div>
        </div>
        <div className="flex justify-between mt-2 text-[8px] font-bold text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] uppercase">
      ...
      <div className={`${cardClass} p-5`}>
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex gap-2">
            <div className="flex items-center gap-1.5"><div className="h-2 w-2 rounded-full bg-[var(--primary)]"></div><span className="text-[10px] font-medium text-slate-700 dark:text-slate-300">Actual</span></div>
      ...
      <div className="break-inside-avoid mb-6 w-full space-y-6">
        <div className="space-y-2">
          <label className="text-[10px] font-bold uppercase tracking-widest text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Input Field</label>
          <div className="relative">
            <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 text-lg">search</span>
            <input className="w-full pl-10 pr-4 py-2 text-sm border border-[var(--border-light)] dark:border-[var(--border-dark)] rounded-xl bg-[var(--surface-light)] dark:bg-[var(--surface-dark)] focus:ring-2 focus:ring-[var(--primary)] focus:border-[var(--primary)] text-slate-900 dark:text-white" placeholder="Search data..."/>
          </div>
        </div>
        <div className="space-y-2">
          <div className="flex gap-2">
            <button className="flex-1 bg-[var(--primary)] text-white text-xs font-bold py-2.5 rounded-xl shadow-sm hover:bg-[var(--primary-hover)] transition-colors">Apply</button>
            <button className="flex-1 bg-[var(--surface-light)] dark:bg-gray-800 border border-[var(--border-light)] dark:border-[var(--border-dark)] text-slate-900 dark:text-white text-xs font-bold py-2.5 rounded-xl transition-colors">Cancel</button>
          </div>
        </div>
        <div className="p-4 design-card">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-900 dark:text-white">Real-time Analytics</span>
            <div className="w-10 h-5 bg-[var(--primary)] rounded-full relative cursor-pointer"><div className="absolute right-0.5 top-0.5 h-4 w-4 bg-white rounded-full transition-transform"></div></div>
          </div>
        </div>
      </div>
      ...
      <div className={`${cardClass} p-5`}>
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xs font-bold uppercase text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] tracking-wider">Device Usage</h3>
        ...
        <div className="flex items-center justify-center relative h-32">
          <svg className="w-24 h-24 transform -rotate-90" viewBox="0 0 36 36">
            ...
            <path className="text-[var(--primary)]" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" fill="none" stroke="currentColor" strokeDasharray="60, 100" strokeWidth="4"></path>
        ...
        <div className="flex justify-center gap-4 mt-2">
          <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-[var(--primary)]"></div><span className="text-[10px] text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Desktop</span></div>
          <div className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-purple-500"></div><span className="text-[10px] text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Mobile</span></div>
        </div>
      </div>
      ...
      <div className={`${cardClass} p-5`}>
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xs font-bold uppercase text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] tracking-wider">Activity Map</h3>
          <span className="material-symbols-outlined text-gray-400 text-sm">grid_on</span>
        </div>
        <div className="flex items-center justify-center h-32">
          <svg className="w-full h-full text-[var(--primary)]" viewBox="0 0 140 70">
      ...
      <div className={`${cardClass} p-5`}>
        <div className="flex justify-between items-center mb-2">
          <h3 className="text-xs font-bold uppercase text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] tracking-wider">System Health</h3>
      ...
      <div className={`${cardClass} p-5`}>
        <div className="flex justify-between items-start mb-6">
          <div>
            ...
            <p className="text-xs text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Organic vs Paid Search</p>
          </div>
          <div className="flex gap-4">
            <div className="text-right">
              <p className="text-[10px] uppercase text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Organic</p>
              <p className="text-lg font-bold text-[var(--primary)]">24.5k</p>
            </div>
            <div className="text-right">
              <p className="text-[10px] uppercase text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Paid</p>
      ...
      <div className={`${cardClass} p-5`}>
        <div className="flex justify-between items-center mb-4">
          <h3 className="text-xs font-bold uppercase text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)] tracking-wider">Demographics</h3>
        ...
        <div className="flex items-end justify-between h-32 gap-3 px-2">
          <div className="w-full flex flex-col justify-end h-full gap-1">
            ...
            <div className="bg-[var(--primary)] w-full rounded-sm h-[40%]"></div>
          </div>
          <div className="w-full flex flex-col justify-end h-full gap-1">
            <div className="bg-purple-400 w-full rounded-sm h-[20%]"></div>
            <div className="bg-[var(--primary)] w-full rounded-sm h-[60%]"></div>
          </div>
          <div className="w-full flex flex-col justify-end h-full gap-1">
            <div className="bg-purple-400 w-full rounded-sm h-[40%]"></div>
            <div className="bg-[var(--primary)] w-full rounded-sm h-[30%]"></div>
          </div>
          <div className="w-full flex flex-col justify-end h-full gap-1">
            <div className="bg-purple-400 w-full rounded-sm h-[25%]"></div>
            <div className="bg-[var(--primary)] w-full rounded-sm h-[55%]"></div>
          </div>
          <div className="w-full flex flex-col justify-end h-full gap-1">
            <div className="bg-purple-400 w-full rounded-sm h-[35%]"></div>
            <div className="bg-[var(--primary)] w-full rounded-sm h-[45%]"></div>
          </div>
        </div>
        <div className="flex justify-center gap-4 mt-3">
          <div className="flex items-center gap-1.5"><div className="h-2 w-2 rounded-full bg-[var(--primary)]"></div><span className="text-[10px] text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Male</span></div>
          <div className="flex items-center gap-1.5"><div className="h-2 w-2 rounded-full bg-purple-400"></div><span className="text-[10px] text-[var(--text-secondary-light)] dark:text-[var(--text-secondary-dark)]">Female</span></div>
        </div>
      </div>
    </>
  );
