...
const ChartsSection: React.FC<ChartsSectionProps> = ({ isEmbedded = false }) => {
  ...
  const cardClass = "design-card p-6 rounded-xl border border-[var(--border-light)] dark:border-[var(--border-dark)] shadow-sm hover:shadow-md transition-shadow break-inside-avoid mb-6 w-full";
    ...
    <>
      ...
      <div className={cardClass}>
        <h3 className="text-sm font-bold text-slate-900 dark:text-white mb-4 uppercase tracking-wider flex items-center gap-2">
          <span className="material-icons-round text-[var(--primary)] text-base">trending_up</span>
          User Growth Trend
        </h3>
